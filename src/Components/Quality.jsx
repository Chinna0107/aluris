...
function Quality() {
  ...
  const qualityCards = [
    { 
      ...
      title: 'Direct Supply From Trusted Rice Mills',
      description: 'We partner with certified rice mills to ensure consistent quality and supply. Our direct sourcing eliminates middlemen, guaranteeing fresh products and competitive pricing for bulk orders.'
    },
    { 
      image: 'https://images.unsplash.com/photo-1553413077-190dd305871c?w=600', 
      title: 'Bulk Orders Ready for Dispatch',
      description: 'Our well-stocked warehouses maintain large inventories of premium rice varieties. We ensure quick processing and dispatch of bulk orders with efficient logistics and timely delivery across regions.'
    },
    { 
      image: 'https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=600', 
      title: 'Quality Paddy From Trusted Farmers',
      description: 'We source premium paddy directly from experienced farmers who follow sustainable farming practices. Our quality checks begin at the farm level to ensure only the best grains reach our mills.'
    },
    { 
      image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=600', 
      title: 'Modern Rice Milling & Sortex Technology',
      description: 'Equipped with state-of-the-art milling machinery and advanced Sortex technology, we ensure precise sorting, cleaning, and grading. This guarantees uniform quality and removes impurities effectively.'
    },
    { 
      image: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600', 
      title: 'Direct Mill to Buyer Supply',
      description: 'By eliminating intermediaries, we offer factory-fresh rice directly to buyers. This ensures better pricing, fresher products, and complete transparency in quality and sourcing.'
    },
    { 
  ...
  return (
    <div style={{ marginTop: '120px', minHeight: '60vh', animation: 'fadeIn 0.8s ease-in', backgroundColor: colors.background }}>
      ...
      <section style={{ background: `linear-gradient(135deg, ${colors.darkGreen} 0%, ${colors.mediumGreen} 100%)`, padding: '60px 20px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>
        ...
        />
        <h1 style={{ color: colors.gold, fontSize: '48px', marginBottom: '10px', fontFamily: 'Georgia, serif', fontWeight: '900' }}>ALURI'S GLOBAL RICE</h1>
      ...
      <section style={{ background: `linear-gradient(135deg, ${colors.darkGreen} 0%, ${colors.mediumGreen} 100%)`, padding: '40px 20px' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px' }}>
          <h2 style={{ color: colors.gold, fontSize: '32px', fontWeight: '900', margin: 0, fontFamily: 'Georgia, serif' }}>ALURI'S GLOBAL RICE</h2>
