      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul>
            ...
            <li><Link to="/about-us" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>About Us</Link></li>
            <li><Link to="/products" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Products</Link></li>
            <li><Link to="/quality" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Quality</Link></li>
          </ul>
        </div>
        <div className="footer-section">
          <h4>Support</h4>
          <ul>
            <li><Link to="/quote" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Get Quote</Link></li>
        ...
        <div className="footer-section">
          ...
          <div className="contact-info">
            <div className="contact-item">
              <strong>Proprietor:</strong> M ANNAPURNAMMA (M.Com, LLB)
            </div>
            <div className="contact-item">
              📍 Visakhapatnam, Andhra Pradesh, India
            </div>
            <div className="contact-item">
              📞 <a href="tel:8074346568">80743 46568</a>
            </div>
            <div className="contact-item">
          ...
          <div className="social-icons">
            <a href="https://wa.me/918074346568" target="_blank" rel="noopener noreferrer" className="social-link" title="WhatsApp">
